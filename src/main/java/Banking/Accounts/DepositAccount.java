 ...
 * Депозитный счет позволяет клиенту хранить средства и начисляет проценты на остаток.
 * Снятие средств запрещено до окончания срока депозита.
 */
public class DepositAccount implements Account {
    ...
    /**
     * Конструктор для создания депозитного счета.
     *
     ...
     * Выбрасывает исключение, так как снятие с депозитного счета запрещено до окончания срока.
     *
     * @param amount сумма для снятия
     * @throws UnsupportedOperationException если попытка снятия средств
     */
    @Override
